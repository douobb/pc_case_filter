            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(),
                  const Text("點擊右上角的漏斗圖示即可進入篩選介面，篩選介面的右上角有兩個按鈕，"
                      "當選擇好自己的搜索條件之後別忘了點擊套用按鈕，如果要清除搜索內容則可以點及初始化按鈕，而底下依序是搜索、排序以及篩選功能。",style: TextStyle(fontSize: 18, height: 1.5),),
                  const SizedBox(height: 15,),
                  ...
                  const Divider(),
                  const Text("在「排序」欄位的最左邊有一個箭頭按鈕，其箭頭方向代表排序方式由大到小(↓)或由小到大(↑)，"
                  ...
                  const Divider(),
                  const Text("篩選欄位包含品牌、體積、價格、GPU&CPU、主板、風扇支援、水冷支援、I/O支援、硬碟支援、側板類型以及其他，點擊該欄位即可展開選項。\n\n"
                  ...
                  const Divider(),
                  const Text("使用or邏輯的欄位：品牌、主板以及側板類型，預設會選擇所有選項，只要有任一選項符合的機殼就會顯示。\n\n"
