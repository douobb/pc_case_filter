    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text("簡介",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(103, 80, 164, 1),),),
            const Divider(),
            const Text("本網站建立原因是因為作者發現原價屋的機殼總覽網頁雖然包含了許多機殼，但是在搜索篩選方面並不方便，"
                ...
                "更新資料時會導致網頁資料被刪除，因此請稍待約三分鐘之後重新載入頁面以取得最新資料。",style: TextStyle(fontSize: 18, height: 1.5),),
            const SizedBox(height: 15,),
            const Text("功能",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(103, 80, 164, 1),),),
            const Divider(),
            ...
            const SizedBox(height: 15,),
            const Text("進入篩選介面",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(103, 80, 164, 1),),),
            const Divider(),
            ...
            const SizedBox(height: 15,),
            const Text("搜索功能",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(103, 80, 164, 1),),),
            const Divider(),
            ...
            const SizedBox(height: 15,),
            const Text("排序功能",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(103, 80, 164, 1),),),
            const Divider(),
            ...
            const SizedBox(height: 15,),
            const Text("篩選功能",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(103, 80, 164, 1),),),
            const Divider(),
            ...
            const SizedBox(height: 15,),
            const Text("篩選邏輯",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(103, 80, 164, 1),),),
            const Divider(),
