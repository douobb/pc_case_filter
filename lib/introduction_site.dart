              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Divider(),
                    Text("篩選欄位包含品牌、體積、價格、GPU&CPU、主板、風扇支援、水冷支援、I/O支援、硬碟支援、側板類型以及其他，點擊該欄位即可展開選項。\n\n"
                        "品牌欄位展開後可以看到一個勾選框，可以一次全選或全不選。包含輸入框的欄位有體積、價格以及GPU&CPU，"
                        "其中價格欄位可輸入整數，其餘的兩個可輸入小數。而「其他」欄位的選項則是使用勾選，剩下的欄位皆為使用按鈕做選擇。",style: TextStyle(fontSize: 18, height: 1.5, color: textColor),),
                    const SizedBox(height: 15,),
                    ...
                    Text("使用or邏輯的欄位：品牌、主板以及側板類型，預設會選擇所有選項，只要有任一選項符合的機殼就會顯示。\n\n"
                        ...
                        "CPU&GPU欄位則要大於所輸入的數值(可容納顯卡及散熱器)才會顯示機殼。",style: TextStyle(fontSize: 18, height: 1.5, color: textColor),),
                  ],
                ),
              ),
            ),
